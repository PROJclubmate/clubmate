...
module.exports = {
  conversationGetUserChat(req, res, next){
  ...
  conversationPostUserMsg(req, res, next){
  ...
  conversationStartNewUser(req, res, next){
  ...
  conversationGetClubChat(req, res, next){
  ...
  conversationPostClubMsg(req, res, next){
    if(!req.body.composedMessage || req.body.composedMessage == ''){
  ...
  conversationStartNewClub(req, res, next){
