...
// Change in currentUser userKeys the mess to show menu of particular mess
router.put('/colleges/:college_name/mess', middleware.isInCollege, messUserChange);

// Show edit mess menu page
router.get('/colleges/:college_name/mess/edit', middleware.isCollegeLevelAdmin, messEditPage);

// Edit mess menu items
router.put('/colleges/:college_name/mess/edit', middleware.isCollegeLevelAdmin, messUpdateMenu);
