...
router.get('/colleges/:college_name/merchandise/add', middleware.isInCollege, addNewMerchandise);
...
router.post('/colleges/:college_name/merchandise', upload.array('images', 10), middleware.isInCollege, uploadNewMerchandise);
...
router.put('/colleges/:college_name/merchandise/:type/:merch_id', middleware.isInCollege, updateMerchandise);

// Delete merch item
router.delete('/colleges/:college_name/merchandise/:type/:merch_id', middleware.isInCollege, deleteMerchandise);
